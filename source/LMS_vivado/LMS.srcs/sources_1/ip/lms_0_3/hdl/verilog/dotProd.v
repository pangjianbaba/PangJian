...
wire   [13:0] x_V_load_phi_fu_243_p130;
reg  signed [13:0] x_V_load_phi_reg_619;
...
wire   [6:0] x_V_load_phi_fu_243_p129;
wire  signed [29:0] grp_fu_401_p3;
wire   [29:0] grp_fu_401_p2;
...
lms_mux_1287_14_1_1_U1(
    ...
    .din126(x_7_V_read),
    .din127(x_7_V_read),
    .din128(x_V_load_phi_fu_243_p129),
    .dout(x_V_load_phi_fu_243_p130)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_reg_610 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        i_reg_194 <= i_3_reg_614;
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        i_reg_194 <= 4'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_reg_610 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        p_Val2_s_reg_182 <= {{grp_fu_401_p3[29:16]}};
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((tmp_reg_610 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_phi_mux_i_phi_fu_198_p4 = i_3_reg_614;
    end else begin
